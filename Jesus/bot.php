#!/usr/bin/env php
<?php
define('BOT_TOKEN', '716396100:AAGPS36GmpXkjg5uLrFoLuAxZvfwv3DJeWY');
...
if (isset($update["message"])) {
  if (in_array($update["message"]["from"]["username"], array('Jesussk', 'XavierOrejarena', 'peruzuela', 'rafikiti', 'jusicuqui', 'Anboabel1', 'Kairodis'))) {
