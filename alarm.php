...
<?php
	...
	while($row = mysqli_fetch_array($result)){
		...
		$price1 = file_get_contents("https://api.binance.com/api/v1/ticker/price?symbol=$coin", false, stream_context_create($arrContextOptions));
		$price = json_decode($price1, true)['price'];
		if (is_numeric($price)) {
