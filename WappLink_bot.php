...
<?php
//@WappLink_bot
define('BOT_TOKEN', '1809118217:');
define('TOKEN_BOT', 'AAE3qvMXaYe9NES9wJDOZ8lYIR2pExf15RM');
define('API_URL', 'https://api.telegram.org/bot'.BOT_TOKEN.TOKEN_BOT.'/');
define('WEBHOOK_URL', 'https://vps239318.vps.ovh.ca/xavier/WappLink_bot.php');
...
function processMessage($message) {
  ...
  if (isset($message['text'])) {
    ...
    if (strpos($text, "/start") === 0) {
      ...
      apiRequest("sendMessage", array('disable_web_page_preview' => True,'chat_id' => $chat_id, "text" => 'https://wa.me/'.$text."
