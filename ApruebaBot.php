...
define('TOKEN_BOT', 'AAEkg4Aou');
define('API_BOT', '-eBPzOE6Ux5vTpdr6pPru6sWJc');
...
function processMessage($message) {
    if ($message['text'] == "/ver"){
        apiRequest("sendMessage", array('chat_id' => $message['chat']['id'], "text" => "version: `7.0`", "parse_mode" => "markdown"));
    }else{
